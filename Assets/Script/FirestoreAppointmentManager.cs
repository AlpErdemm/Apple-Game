...
public class FirestoreAppointmentManager : MonoBehaviour
{
    ...
    public class Patient
    {
        ...
        public Patient(string name, string surname, int rom)
        {
            this.name = name;
    ...
    public class Session
    {
        ...
        public Session(bool active, int mode, int hand)
        {
            this.active = active;
            this.mode = mode;
            this.hand = hand;
    ...
    public void AddNewPatient(string name, string surname, int rom)
    {
        // Create dummy patient data inline
        ...
        db.Collection("patients").AddAsync(patientData).ContinueWithOnMainThread(task =>
        {
            if (task.IsCompletedSuccessfully)
            {
                Debug.Log("Dummy patient added with ID: " + task.Result.Id);
            }
            else
            {
                Debug.LogError("Failed to add dummy patient: " + task.Exception);
            }
        });
    }
